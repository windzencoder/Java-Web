...
<body>
					...
					<tr>
						<td bgcolor="#353c44" width="100%" height="24px">
							<table width="100%" border="0" align="center" cellpadding="0"
								cellspacing="0">
								<tr>
									<td width="18px" valign="bottom"><img src="images/tb.gif"
										width="14px" height="14px" /></td>
									<td valign="bottom"><span class="style1">修改教师资料</span></td>
								</tr>
							</table>
						</td>
					</tr>
	...
	<s:form action="adminteacher.action" enctype="multipart/form-data" method="post" id="uploadfile_id">
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">学位：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">
						<input type="text" name="degree" id="sellPrice_id"
							style="width: 200" /> <font color="#CC0033 " size="2"><span
							id="result3"></span> </font> <font color="red">*</font>
					</div>
				</td>
			</tr>
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">职位：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">
						<input type="text" name="position" id="discount_id"
							style="width: 200" /> <font color="#CC0033 " size="2"><span
							id="result4"></span> </font> <font color="red">*</font>
					</div>
				</td>
			</tr>
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">教育背景：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">
						<input type="text" name="eduBackground" id="storage_id"
							style="width: 200" /> <font color="#CC0033 " size="2"><span
							id="result5"></span> </font> <font color="red">*</font>
					</div>
				</td>
			</tr>
			...
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">所在学院：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">

						<input class="Wdate" type="text" name="college"
							id="tradeStartDate_id" style="width: 200" /> <font
							color="#CC0033 " size="2"><span id="result6"></span> </font> <font
							color="red">*</font>
					</div>
				</td>
			</tr>
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">联系地址:</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">
						<input class="Wdate" type="text" name="address"
							id="tradeEndDate_id" style="width: 200" /> <font
							color="#CC0033 " size="2"><span id="result7"></span> </font> <font
							color="red">*</font>
					</div>
				</td>
			</tr>
			...
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">学术方向：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">

						<input class="Wdate" type="text" name="direction"
							id="consumeStartDate_id" style="width: 200" /> <font
							color="#CC0033 " size="2"><span id="result8"></span> </font> <font
							color="red">*</font>
					</div>
				</td>
			</tr>
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">简介：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">

						<s:textarea type="" name="intro" id="consumeEndDate_id"
			...
			<tr height="50px">
				<td bgcolor="#ffffff" width="50%" align="right">
					<div class="style3">学术成就：</div>
				</td>
				<td bgcolor="#ffffff">
					<div class="style5">
						<s:textarea name="achievement" id="keywords_id" style="width: 200"
							theme="simple" />
		...
		<table align="center">
			<tr>
				...
				<td align="center"><s:submit type="image"
						src="images/admin/submit.png" id="sub" method="correctTeacher"
						theme="simple" /></td>
			</tr>
		</table>
